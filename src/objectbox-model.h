...
static inline OBX_model* create_obx_model() {
    ...
    obx_model_entity(model, "Task", 1, 3910666551706356064);
    obx_model_property(model, "id", OBXPropertyType_Long, 1, 3880740074206620380);
    obx_model_property_flags(model, OBXPropertyFlags_ID);
    obx_model_property(model, "text", OBXPropertyType_String, 2, 322972552688934616);
    obx_model_property(model, "date_created", OBXPropertyType_Long, 3, 4120016064295858714);
    obx_model_property_flags(model, OBXPropertyFlags_UNSIGNED);
    obx_model_property(model, "date_finished", OBXPropertyType_Long, 4, 6864939333553245339);
    obx_model_property_flags(model, OBXPropertyFlags_UNSIGNED);
    obx_model_entity_last_property_id(model, 4, 6864939333553245339);
    
    obx_model_last_entity_id(model, 1, 3910666551706356064);
